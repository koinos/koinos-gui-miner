...
- [Koinos Miner](#koinos-miner)
  - [Table of Contents](#table-of-contents)
    ...
    - [License](#license)
<a name="koinos-miner-overview"></a>
### Koinos Miner Overview
<a name="ethereum-endpoint"></a>
#### Ethereum Endpoint
...
<a name="recipient-address"></a>
#### Recipient Address
The Recipient Address is the Ethereum Address in which KOIN will be rewarded. It is recommended that the Recipient Address is different than the Funding Address. For more information on this topic see [Key Management](#key-management).
<a name="power-button"></a>
#### Power Button
